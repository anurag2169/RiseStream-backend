...
const getAllVideos = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, videos, "All Videos Get succesfully"))
})
...
const publishAVideo = asyncHandler(async (req, res) => {
    ...
    if (!thumbnail) {
        throw new ApiError(500, "Something went wrong while Uploading the thubnail")
    }
    ...
    return res.status(200).json(new ApiResponse(200, allVideos, 'Video Published succesfully'))
})
...
const getVideoById = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, video, "video get successfully"))
})
...
const togglePublishStatus = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, isPublishedVideo, 'Video published status Updated successfully'))
})
